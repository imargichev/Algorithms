...
public class MergeSort {
     ...
     * It initializes an array of integers, sorts it using the MergeSort algorithm, and prints the sorted array.
     *
     ...
     * @param m The ending index of the first subarray and the middle point.
